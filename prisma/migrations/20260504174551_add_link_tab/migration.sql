...
INSERT INTO "new_Link" ("createdAt", "disabled", "ecpm", "id", "impressions", "revenue", "splitterId", "type", "url", "utms") SELECT "createdAt", "disabled", "ecpm", "id", "impressions", "revenue", "splitterId", "type", "url", "utms" FROM "Link";
DROP TABLE "Link";
